...
$(function(){var e=$("#menu").mmenu({extensions:["effect-menu-slide"],navbar:{title:'<div class= "logo_menu" ><span>b o s t f o l i a</span></div>'},offCanvas:{position:"right"}}),n=$(".owl-carousel");prev=$("#prev"),next=$("#next"),n.owlCarousel({items:1,loop:!0,dots:!0,nav:!0,navText:["<span class='pe-7s-angle-left arrowLeft owl-prev' id='prev'></span>","<span class='pe-7s-angle-right arrowRight owl-next' id='next'></span>"]}),$(".projects_links ul li a").on("click",function(e){e.preventDefault(),$(".projects_links ul li a").removeClass("active_proj_link"),$(this).addClass("active_proj_link"),$(".projects div").removeClass("active_proj"),console.log(n);var n=$(this).attr("href");$(n).addClass("active_proj")});var s=$("#menu-btn"),i=e.data("mmenu");s.on("click",function(){i.open()}),i.bind("open:finish",function(){setTimeout(function(){s.addClass("is-active")},100)}),i.bind("close:finish",function(){setTimeout(function(){s.removeClass("is-active")},100)})});