...
$(function(){var e=$("#menu").mmenu({extensions:["effect-menu-slide"],navbar:{title:'<div class= "logo_menu" ><span>b o s t f o l i a</span></div>'},offCanvas:{position:"right"}}),n=$(".owl-carousel");prev=$("#prev"),next=$("#next"),n.owlCarousel({items:1,loop:!0,dots:!0}),next.on("click",function(){n.trigger("next.owl.carousel")}),prev.on("click",function(){n.trigger("prev.owl.carousel")}),$(".projects_links ul li a").on("click",function(e){e.preventDefault(),$(".projects_links ul li a").removeClass("active_proj_link"),$(this).addClass("active_proj_link"),$(".projects div").removeClass("active_proj"),console.log(n);var n=$(this).attr("href");$(n).addClass("active_proj")});var i=$("#menu-btn"),o=e.data("mmenu");i.on("click",function(){o.open()}),o.bind("open:finish",function(){setTimeout(function(){i.addClass("is-active")},100)}),o.bind("close:finish",function(){setTimeout(function(){i.removeClass("is-active")},100)})});