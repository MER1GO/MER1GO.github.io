...
OAnimation:"oAnimationEnd",animation:"animationend"}}},u={csstransforms:function(){return!!r("transform")},csstransforms3d:function(){return!!r("perspective")},csstransitions:function(){return!!r("transition")},cssanimations:function(){return!!r("animation")}};u.csstransitions()&&(t.support.transition=new String(s("transition")),t.support.transition.end=l.transition.end[t.support.transition]),u.cssanimations()&&(t.support.animation=new String(s("animation")),t.support.animation.end=l.animation.end[t.support.animation]),u.csstransforms()&&(t.support.transform=new String(s("transform")),t.support.transform3d=u.csstransforms3d())}(window.Zepto||window.jQuery,window,document),function(t){function e(){o.hasClass(c)?a.toggleClass(h):a.toggleClass(p),m&&o.one("transitionend",function(){m.focus()})}function n(){o.hasClass(c)?a.removeClass(h):a.removeClass(p)}function i(){o.hasClass(c)?(a.addClass(h),o.animate({left:"0px"},v),l.animate({left:y},v),u.animate({left:y},v)):(a.addClass(p),o.animate({right:"0px"},v),l.animate({right:y},v),u.animate({right:y},v)),m&&m.focus()}function r(){o.hasClass(c)?(a.removeClass(h),o.animate({left:"-"+y},v),l.animate({left:"0px"},v),u.animate({left:"0px"},v)):(a.removeClass(p),o.animate({right:"-"+y},v),l.animate({right:"0px"},v),u.animate({right:"0px"},v))}function s(){t(x).addClass(_),t(x).on("click",function(){var e=t(this);e.hasClass(_)?(t(x).addClass(_).removeClass(w),e.removeClass(_).addClass(w)):e.addClass(_).removeClass(w)})}var o=t(".pushy"),a=t("body"),l=t("#container"),u=t(".push"),c="pushy-left",h="pushy-open-left",p="pushy-open-right",d=t(".site-overlay"),f=t(".menu-btn, .pushy-link"),g=t(".menu-btn"),m=t(o.data("focus")),v=200,y=o.width()+"px",x=".pushy-submenu",w="pushy-submenu-open",_="pushy-submenu-closed";t(x),t(document).keyup(function(t){27==t.keyCode&&(a.hasClass(h)||a.hasClass(p))&&(b?n():(r(),C=!1),g&&g.focus())});var b=function(){var t=document.createElement("p"),e=!1,n={webkitTransform:"-webkit-transform",OTransform:"-o-transform",msTransform:"-ms-transform",MozTransform:"-moz-transform",transform:"transform"};if(null!==document.body){document.body.insertBefore(t,null);for(var i in n)void 0!==t.style[i]&&(t.style[i]="translate3d(1px,1px,1px)",e=window.getComputedStyle(t).getPropertyValue(n[i]));return document.body.removeChild(t),void 0!==e&&e.length>0&&"none"!==e}return!1}();if(b)s(),f.on("click",function(){e()}),d.on("click",function(){e()});else{a.addClass("no-csstransforms3d"),o.hasClass(c)?o.css({left:"-"+y}):o.css({right:"-"+y}),l.css({"overflow-x":"hidden"});var C=!1;s(),f.on("click",function(){C?(r(),C=!1):(i(),C=!0)}),d.on("click",function(){C?(r(),C=!1):(i(),C=!0)})}}(jQuery),$(function(){$(".owl-carousel").owlCarousel({loop:!0,items:1,margin:-1,nav:!0,center:!0,navText:["<span class='arrowLeft owl-prev' id='prev'></span>","<span class='arrowRight owl-next' id='next'></span>"]})});