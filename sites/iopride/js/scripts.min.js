...
$(function(){function e(e){var t=0;e.each(function(){currentHeight=$(this).height(),currentHeight>t&&(t=currentHeight)}),e.height(t)}new Walkway({selector:"#svg_1",duration:1500,easing:function(e){return e*e*e}}).draw(),$("#merch-btn").hide().fadeIn(2300),$(document).ready(function(){e($(".product_cont > div"))}),$(".parallax-window").parallax({imageSrc:"img/fon1-min.jpg",speed:.4}),$(".one_member").hide(),$("#senya").show(),$(".tabs ul li").on("click",function(){event.preventDefault(),$(".one_member").hide(),$(".tabs ul li").removeClass("active_tab"),$(this).addClass("active_tab");var e=$(this).children().attr("href");$(e).show()}),$(".sp-wrap").smoothproducts()});