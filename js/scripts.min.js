...
$(function(){$("#fullscreen").fullpage();var e=$("#about_slider");prev=$("#prev"),next=$("#next"),e.owlCarousel({margin:100,loop:!0,dots:!1,responsiveClass:!0,autoplay:!0,responsive:{0:{items:1},480:{items:3}}}),$("#work_slider").owlCarousel({items:1,loop:!0,dots:!0}),next.on("click",function(){e.trigger("next.owl.carousel")}),prev.on("click",function(){e.trigger("prev.owl.carousel")})});